/* Copied from nixpkgs, with the no_anon_password option added */
...
let
  ...
  */
  ...
  cfg = config.services.barrucadu-vsftpd;
...

{
  ...
  config = mkIf cfg.enable {
    ...
    services.barrucadu-vsftpd.userlist = if cfg.userlistDeny then ["root"] else [];
